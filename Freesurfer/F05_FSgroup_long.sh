...
cd /ifs/loni/groups/matherlab/Users/Hyunjoo/2018_HRVT_MRI_Study/Result/Freesurfer_long_group
for sf in $statfile
do
...
do
export SUBJECTS_DIR=${basedir}
asegstats2table --subjects $sublist --meas $measure --tablefile ${session}_${statfile}_${measure}.txt
done
done
done
